...
go-licenses save . --save_path=license-files --ignore github.com/mattn/go-localereader --ignore github.com/adrianliechti/bridge --ignore github.com/adrianliechti/prism || goto :error
